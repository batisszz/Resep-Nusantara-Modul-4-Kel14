    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8">
        {recipes.map((recipe, index) => {
          // ✅ Beda favorit berdasarkan ID + type
          ...
          return (
            ...
            >
              ...
              >
                ...
                <button
                  onClick={(e) => {
                    e.stopPropagation(); // biar gak trigger klik ke detail
                    onToggleFavorite && onToggleFavorite(recipe);
                  }}
                  className="absolute top-3 right-3 z-20 bg-white/70 rounded-full p-2 hover:bg-white transition"
                >
                  <Heart
                    className={`w-5 h-5 ${
